...
## tclsh, but don't want oommf_threads, override here.
 $config SetValue oommf_threads 1  ;# 1 to force threaded build,
...
if {[string match g++* $ccbasename]} {
   ...
   lappend opts -std=c++0x ; # Adds support for generation of normal distributed pseudo-random numbers
...
if {[string match g++* $lbasename]} {
    ...
    $config SetValue program_linker_uses_-L-l {1}
 } elseif {[string match openCC* $lbasename]} {
