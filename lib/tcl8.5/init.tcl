...
#
# ActiveState ActiveTcl 8.5.12.0.296033 Linux/x86_64, Fri Jul 27 14:42:40 PDT 2012
#
...
namespace eval ::activestate {
	...
	maturity      {final}
	arch          {linux-x86_64}
	buildtime,sec {1343425360}
	buildtime,fmt {Fri Jul 27 14:42:40 PDT 2012}
	as,mode       {normal}
    }
    ...
    variable  config
    array set config {
	{ActiveTcl} {ActiveState ActiveTcl 8.5.12.0.296033 Linux/x86_64 @ Fri Jul 27 14:42:40 PDT 2012 / normal}
    }
}

package provide {ActiveTcl} {8.5.12.0.296033}
