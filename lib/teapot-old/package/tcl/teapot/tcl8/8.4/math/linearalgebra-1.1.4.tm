...
# Meta as::build::date 2013-08-04
# Meta as::origin      http://sourceforge.net/projects/tcllib
# Meta category        Tcl Math Library
# Meta description     Linear Algebra
# Meta license         BSD
# Meta platform        tcl
# Meta require         {Tcl 8.4}
# Meta subject         matrices {linear equations} matrix {linear algebra}
# Meta subject         {least squares} vectors math
# Meta summary         math::linearalgebra
# @@ Meta End
