...
# installed.
TCL_PREFIX='/home/windi/ViennaNovoFlop/ViennaNovoFlop-dev'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/home/windi/ViennaNovoFlop/ViennaNovoFlop-dev'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/home/windi/ViennaNovoFlop/ViennaNovoFlop-dev/lib -ltcl8.5'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/home/windi/ViennaNovoFlop/ViennaNovoFlop-dev/include/tcl8.5'
...
TCL_PACKAGE_PATH='/home/windi/ViennaNovoFlop/ViennaNovoFlop-dev/lib /home/andreask/dbn/lba/GlobalBuildArena/builds/linux-x86_64/out/lib '
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/home/windi/ViennaNovoFlop/ViennaNovoFlop-dev/lib -ltclstub8.5'
...
TCL_STUB_LIB_PATH='/home/windi/ViennaNovoFlop/ViennaNovoFlop-dev/lib/libtclstub8.5.a'
