...
#
# Last modified on: $Date: 2008-07-28 21:55:26 $
...
#
# If multiple instances of the same option appear in $argv, <script> will
# still be evaluated only once, using the arguments which appear latest
# in $argv.  Although the arguments to earlier instances of the option
# will not be passed to <script>, they will still be validated.  The
# <script> may raise an error, which will be passed along as an error
# raised by [Oc_CommandLine Parse].
# 
