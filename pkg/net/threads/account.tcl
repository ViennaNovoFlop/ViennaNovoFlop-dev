...
#
# Last modified on: $Date: 2009-11-13 20:05:43 $
...
# can win the race.  The "associate" message set an OID as the referent
...
$master(protocol) AddMessage start associate {n oid} {
    ...
    global name info
#puts stderr "Request to associate $oid with $n..."
...
#puts stderr "$oid now known by name $n"
    Oc_EventHandler Generate NotifyClaim $n
