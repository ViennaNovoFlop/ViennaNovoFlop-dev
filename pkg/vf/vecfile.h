...
enum Vf_OvfDataStyle { vf_oascii, vf_obin4, vf_obin8 };
...
public:
  ...
  void ReadData(Tcl_Channel inchan,OC_REAL8m* data) const;
  ...
  void WriteHeader(Tcl_Channel outchan,
                   Vf_OvfFileVersion version=vf_ovf_latest) const;
