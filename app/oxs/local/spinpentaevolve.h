...
#ifndef _OXS_SPINSLONEVOLVE
#define _OXS_SPINSLONEVOLVE
...
/* End includes */
class Oxs_SpinPentaEvolve:public Oxs_TimeEvolver {
private:
  mutable OC_UINT4m mesh_id;

  // Spin-transfer polarization field data structures
  Oxs_OwnedPointer<Oxs_ScalarField> P1_init;
  Oxs_OwnedPointer<Oxs_ScalarField> P2_init;
  Oxs_OwnedPointer<Oxs_ScalarField> J_init;
  Oxs_OwnedPointer<Oxs_VectorField> mp1_init;
  Oxs_OwnedPointer<Oxs_VectorField> mp2_init;

  mutable Oxs_MeshValue<OC_REAL8m> polarization1;
  mutable Oxs_MeshValue<OC_REAL8m> polarization2;
  mutable Oxs_MeshValue<OC_REAL8m> A;
  mutable Oxs_MeshValue<OC_REAL8m> B;
  mutable Oxs_MeshValue<ThreeVector> mp1;
  mutable Oxs_MeshValue<ThreeVector> mp2;
  ...
  enum InterfaceType { IT_INVALID, IT_METAL, IT_OXIDE }; // interface type metal -> spin valve or oxide -> MTJ
  InterfaceType interface1_type;
  InterfaceType interface2_type;
  ...
  Oxs_ScalarOutput<Oxs_SpinPentaEvolve> max_dm_dt_output;
  Oxs_ScalarOutput<Oxs_SpinPentaEvolve> dE_dt_output;
  Oxs_ScalarOutput<Oxs_SpinPentaEvolve> delta_E_output;
  Oxs_ScalarOutput<Oxs_SpinPentaEvolve> ave_J_output;
  Oxs_VectorFieldOutput<Oxs_SpinPentaEvolve> dm_dt_output;
  Oxs_VectorFieldOutput<Oxs_SpinPentaEvolve> mxH_output;
  Oxs_VectorFieldOutput<Oxs_SpinPentaEvolve> spin_torque_output;
  Oxs_VectorFieldOutput<Oxs_SpinPentaEvolve> Jmp_output;
...
#define RKStepFuncSig(NAME) \
  ...
  RKStepFuncSig((Oxs_SpinPentaEvolve::* rkstep_ptr));
  ...
  Oxs_SpinPentaEvolve(const Oxs_SpinPentaEvolve&);
  Oxs_SpinPentaEvolve& operator=(const Oxs_SpinPentaEvolve&);

public:
  virtual const char* ClassName() const; // ClassName() is
  /// automatically generated by the OXS_EXT_REGISTER macro.
  virtual OC_BOOL Init();
  Oxs_SpinPentaEvolve(const char* name,     // Child instance id
		       Oxs_Director* newdtr, // App director
		       const char* argstr);  // MIF input block parameters
  virtual ~Oxs_SpinPentaEvolve();
