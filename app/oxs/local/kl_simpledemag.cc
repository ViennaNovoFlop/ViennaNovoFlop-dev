...
// Helper function
OC_UINT4m Klm_SimpleDemag_PBC::NextPowerOfTwo(OC_UINT4m n) const
...
{ // This routine is conceptually const.
  ...
  for(k=0;k<zdim;k++) for(j=0;j<ydim;j++) for(i=0;i<xdim;i++) {
    ...
    OC_REALWIDE coef = scale*demag_pbc.CalculateSDA(n00, i, j, k); 
  ...
  for(k=0;k<zdim;k++) for(j=0;j<ydim;j++) for(i=0;i<xdim;i++) {
    ...
    OC_REALWIDE coef = scale*demag_pbc.CalculateSDA(n11, i, j, k); 
  ...
  for(k=0;k<zdim;k++) for(j=0;j<ydim;j++) for(i=0;i<xdim;i++) {
    ...
    OC_REALWIDE coef = scale*demag_pbc.CalculateSDA(n22, i, j, k); 
  ...
  for(k=0;k<zdim;k++) for(j=0;j<ydim;j++) for(i=0;i<xdim;i++) {
    ...
    OC_REALWIDE coef = scale*demag_pbc.CalculateSDA(n01, i, j, k); 
  ...
  for(k=0;k<zdim;k++) for(j=0;j<ydim;j++) for(i=0;i<xdim;i++) {
    ...
    OC_REALWIDE coef = scale*demag_pbc.CalculateSDA(n02, i, j, k); 
  ...
  for(k=0;k<zdim;k++) for(j=0;j<ydim;j++) for(i=0;i<xdim;i++) {
    ...
    OC_REALWIDE coef = scale*demag_pbc.CalculateSDA(n12, i, j, k); 
