...
#ifndef _ANV_SPINT3DEVOLVE
#define _ANV_SPINT3DEVOLVE
...
/* End includes */
class Anv_SpinT3DEvolve:public Oxs_TimeEvolver {
private:
...
// extension for y and z direction 14.06.2012 twindbach
  ...
  Oxs_ScalarOutput<Anv_SpinT3DEvolve> max_dm_dt_output;
  Oxs_ScalarOutput<Anv_SpinT3DEvolve> dE_dt_output;
  Oxs_ScalarOutput<Anv_SpinT3DEvolve> delta_E_output;
  Oxs_ScalarOutput<Anv_SpinT3DEvolve> ave_u_output;
  Oxs_VectorFieldOutput<Anv_SpinT3DEvolve> dm_dt_output;
  Oxs_VectorFieldOutput<Anv_SpinT3DEvolve> mxH_output;
  Oxs_VectorFieldOutput<Anv_SpinT3DEvolve> spin_torque_output;
...
#define RKStepFuncSig(NAME) \
  ...
  RKStepFuncSig((Anv_SpinT3DEvolve::* rkstep_ptr));
  ...
  Anv_SpinT3DEvolve(const Anv_SpinT3DEvolve&);
  Anv_SpinT3DEvolve& operator=(const Anv_SpinT3DEvolve&);

public:
  virtual const char* ClassName() const; // ClassName() is
  /// automatically generated by the OXS_EXT_REGISTER macro.
  virtual OC_BOOL Init();
  Anv_SpinT3DEvolve(const char* name,     // Child instance id
		       Oxs_Director* newdtr, // App director
		       const char* argstr);  // MIF input block parameters
  virtual ~Anv_SpinT3DEvolve();
