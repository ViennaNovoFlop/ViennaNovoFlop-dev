 ...
 * import magnetization ThreeVectors.  This Oxs_Eddy class is a
...
class Oxs_Eddy:public Oxs_Energy {

  friend class Oxs_FFTLocker;
  friend class _Oxs_EddyFFTxThread;
  friend class _Oxs_EddyiFFTxDotThread;
  friend class _Oxs_EddyFFTyThread;
  friend class _Oxs_EddyFFTyConvolveThread;
  friend class _Oxs_EddyFFTzConvolveThread;
...
private:
  ...
  mutable Oxs_MeshValue<OC_REAL8m> J;
  mutable Oxs_MeshValue<OC_REAL8m> J_scratch; // for time profile modifications
  ...
  mutable OXS_FFT_REAL_TYPE *Jtemp;  // Temporary space to hold mp[]*J[]
  ...
  public:
    ...
    /// Oxs_Eddy object gets a separate locker.
    /// See Oxs_Eddy member function MakeLockerName().
    ...
    Oxs_FFTLocker_Info(OC_INDEX in_rdimx,OC_INDEX in_rdimy,OC_INDEX in_rdimz,
                       ...
                       OC_INDEX in_embed_block_size,const char* in_name)
    ...
    void Set(OC_INDEX in_rdimx,OC_INDEX in_rdimy,OC_INDEX in_rdimz,
             OC_INDEX in_cdimx,OC_INDEX in_cdimy,OC_INDEX in_cdimz,
             OC_INDEX in_embed_block_size,const String& in_name) {
      rdimx = in_rdimx;      rdimy = in_rdimy;      rdimz = in_rdimz;
      cdimx = in_cdimx;      cdimy = in_cdimy;      cdimz = in_cdimz;
...
public:
  ...
  Oxs_Eddy(const char* name,     // Child instance id
