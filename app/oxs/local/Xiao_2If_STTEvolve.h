...
#ifndef _X2IF_STTEvolve
#define _X2IF_STTEvolve
...
class X2IF_STTEvolve:public Oxs_TimeEvolver {
private:
  ...
  Oxs_ScalarOutput<X2IF_STTEvolve> max_dm_dt_output;
  Oxs_ScalarOutput<X2IF_STTEvolve> dE_dt_output;
  Oxs_ScalarOutput<X2IF_STTEvolve> delta_E_output;
  Oxs_ScalarOutput<X2IF_STTEvolve> average_J_output;
  Oxs_ScalarOutput<X2IF_STTEvolve> ave_If1_STT_output;
  Oxs_ScalarOutput<X2IF_STTEvolve> ave_If2_STT_output;
  Oxs_VectorFieldOutput<X2IF_STTEvolve> dm_dt_output;
  Oxs_VectorFieldOutput<X2IF_STTEvolve> mxH_output;
  Oxs_VectorFieldOutput<X2IF_STTEvolve> spin_torque_interface1_output;
  Oxs_VectorFieldOutput<X2IF_STTEvolve> spin_torque_interface2_output;


  // Scratch space
  Oxs_MeshValue<OC_REAL8m> temp_energy;
  Oxs_MeshValue<OC_REAL8m> xi;
...
#define RKStepFuncSig(NAME) \
  ...
  RKStepFuncSig((X2IF_STTEvolve::* rkstep_ptr));
  ...
  X2IF_STTEvolve(const X2IF_STTEvolve&);
  X2IF_STTEvolve& operator=(const X2IF_STTEvolve&);
...
public:
  ...
  X2IF_STTEvolve(const char* name,     // Child instance id
		       Oxs_Director* newdtr, // App director
		       const char* argstr);  // MIF input block parameters
  virtual ~X2IF_STTEvolve();
