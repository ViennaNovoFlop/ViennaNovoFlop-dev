...
/* End includes */
class Oxs_SpinSlonEvolve:public Oxs_TimeEvolver {
private:
...
//Zeng DOI:10.1038/srep01426, Sankey DOI:10.1038/nphys783 --> field torque boost under voltage load
  ...
  Oxs_ScalarOutput<Oxs_SpinSlonEvolve> max_dm_dt_output;
  Oxs_ScalarOutput<Oxs_SpinSlonEvolve> dE_dt_output;
  Oxs_ScalarOutput<Oxs_SpinSlonEvolve> delta_E_output;
  Oxs_ScalarOutput<Oxs_SpinSlonEvolve> ave_J_output;
  Oxs_VectorFieldOutput<Oxs_SpinSlonEvolve> dm_dt_output;
  Oxs_VectorFieldOutput<Oxs_SpinSlonEvolve> mxH_output;
  Oxs_VectorFieldOutput<Oxs_SpinSlonEvolve> spin_torque_output;
  Oxs_VectorFieldOutput<Oxs_SpinSlonEvolve> Jmp_output;
...
#define RKStepFuncSig(NAME) \
  ...
  RKStepFuncSig((Oxs_SpinSlonEvolve::* rkstep_ptr));
  ...
  Oxs_SpinSlonEvolve(const Oxs_SpinSlonEvolve&);
  Oxs_SpinSlonEvolve& operator=(const Oxs_SpinSlonEvolve&);

public:
  virtual const char* ClassName() const; // ClassName() is
  /// automatically generated by the OXS_EXT_REGISTER macro.
  virtual OC_BOOL Init();
  Oxs_SpinSlonEvolve(const char* name,     // Child instance id
		       Oxs_Director* newdtr, // App director
		       const char* argstr);  // MIF input block parameters
  virtual ~Oxs_SpinSlonEvolve();
