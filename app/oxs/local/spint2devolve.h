...
#ifndef _ANV_SPINT2DEVOLVE
#define _ANV_SPINT2DEVOLVE
...
/* End includes */
class Anv_SpinT2DEvolve:public Oxs_TimeEvolver {
private:
...
//current flow direction; 14.06.2012 twindbach
  Oxs_OwnedPointer<Oxs_VectorField> j_init;
  mutable Oxs_MeshValue<ThreeVector> j; 
  //OC_REAL8m ave_j; // just for debugging

//switch for gradient order
  OC_UINT4m gradient_order;
  ...
  // should be changed to arrays in the future.
	...
	OC_UINT4m n_x; // nb of cells in x direction

// extension for y and z direction 14.06.2012 twindbach
        OC_REAL8m Ystep;
        OC_UINT4m n_y;
        OC_REAL8m Zstep;
        OC_UINT4m n_z;
  ...
  Oxs_ScalarOutput<Anv_SpinT2DEvolve> max_dm_dt_output;
  Oxs_ScalarOutput<Anv_SpinT2DEvolve> dE_dt_output;
  Oxs_ScalarOutput<Anv_SpinT2DEvolve> delta_E_output;
  Oxs_ScalarOutput<Anv_SpinT2DEvolve> ave_u_output;
  Oxs_VectorFieldOutput<Anv_SpinT2DEvolve> dm_dt_output;
  Oxs_VectorFieldOutput<Anv_SpinT2DEvolve> mxH_output;
  Oxs_VectorFieldOutput<Anv_SpinT2DEvolve> spin_torque_output;
...
#define RKStepFuncSig(NAME) \
  ...
  RKStepFuncSig((Anv_SpinT2DEvolve::* rkstep_ptr));
  ...
  Anv_SpinT2DEvolve(const Anv_SpinT2DEvolve&);
  Anv_SpinT2DEvolve& operator=(const Anv_SpinT2DEvolve&);

public:
  virtual const char* ClassName() const; // ClassName() is
  /// automatically generated by the OXS_EXT_REGISTER macro.
  virtual OC_BOOL Init();
  Anv_SpinT2DEvolve(const char* name,     // Child instance id
		       Oxs_Director* newdtr, // App director
		       const char* argstr);  // MIF input block parameters
  virtual ~Anv_SpinT2DEvolve();
