...
/* End includes */
class Oxs_SpinSlonFLTEvolve:public Oxs_TimeEvolver {
private:
...
//Zeng DOI:10.1038/srep01426, Sankey DOI:10.1038/nphys783 --> field torque boost under voltage load
  ...
  Oxs_ScalarOutput<Oxs_SpinSlonFLTEvolve> max_dm_dt_output;
  Oxs_ScalarOutput<Oxs_SpinSlonFLTEvolve> dE_dt_output;
  Oxs_ScalarOutput<Oxs_SpinSlonFLTEvolve> delta_E_output;
  Oxs_ScalarOutput<Oxs_SpinSlonFLTEvolve> ave_J_output;
  Oxs_VectorFieldOutput<Oxs_SpinSlonFLTEvolve> dm_dt_output;
  Oxs_VectorFieldOutput<Oxs_SpinSlonFLTEvolve> mxH_output;
  Oxs_VectorFieldOutput<Oxs_SpinSlonFLTEvolve> spin_torque_output;
  Oxs_VectorFieldOutput<Oxs_SpinSlonFLTEvolve> Jmp_output;
...
#define RKStepFuncSig(NAME) \
  ...
  RKStepFuncSig((Oxs_SpinSlonFLTEvolve::* rkstep_ptr));
  ...
  Oxs_SpinSlonFLTEvolve(const Oxs_SpinSlonFLTEvolve&);
  Oxs_SpinSlonFLTEvolve& operator=(const Oxs_SpinSlonFLTEvolve&);

public:
  virtual const char* ClassName() const; // ClassName() is
  /// automatically generated by the OXS_EXT_REGISTER macro.
  virtual OC_BOOL Init();
  Oxs_SpinSlonFLTEvolve(const char* name,     // Child instance id
		       Oxs_Director* newdtr, // App director
		       const char* argstr);  // MIF input block parameters
  virtual ~Oxs_SpinSlonFLTEvolve();
