...
#ifndef _OXS_SPINSHSTTEVOLVE
#define _OXS_SPINSHSTTEVOLVE
...
/* End includes */
class Oxs_SpinSHSTTEvolve:public Oxs_TimeEvolver {
private:
...
//  mutable Oxs_MeshValue<OC_REAL8m> icsh;// covered by A2
  ...
  Oxs_ScalarOutput<Oxs_SpinSHSTTEvolve> max_dm_dt_output;
  Oxs_ScalarOutput<Oxs_SpinSHSTTEvolve> dE_dt_output;
  Oxs_ScalarOutput<Oxs_SpinSHSTTEvolve> delta_E_output;
  Oxs_ScalarOutput<Oxs_SpinSHSTTEvolve> ave_J_output;
  Oxs_ScalarOutput<Oxs_SpinSHSTTEvolve> ave_ICSH_output;
  Oxs_VectorFieldOutput<Oxs_SpinSHSTTEvolve> dm_dt_output;
  Oxs_VectorFieldOutput<Oxs_SpinSHSTTEvolve> mxH_output;
  Oxs_VectorFieldOutput<Oxs_SpinSHSTTEvolve> spin_torque_output;
  Oxs_VectorFieldOutput<Oxs_SpinSHSTTEvolve> Jmp_output;
...
#define RKStepFuncSig(NAME) \
  ...
  RKStepFuncSig((Oxs_SpinSHSTTEvolve::* rkstep_ptr));
  ...
  Oxs_SpinSHSTTEvolve(const Oxs_SpinSHSTTEvolve&);
  Oxs_SpinSHSTTEvolve& operator=(const Oxs_SpinSHSTTEvolve&);

public:
  virtual const char* ClassName() const; // ClassName() is
  /// automatically generated by the OXS_EXT_REGISTER macro.
  virtual OC_BOOL Init();
  Oxs_SpinSHSTTEvolve(const char* name,     // Child instance id
		       Oxs_Director* newdtr, // App director
		       const char* argstr);  // MIF input block parameters
  virtual ~Oxs_SpinSHSTTEvolve();
