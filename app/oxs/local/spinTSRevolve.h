/* FILE: spinTSRevolve.h                          -*-Mode: c++-*-
 *
 * Concrete evolver class, is derived from Oxs_SpinXferEvolve which is 
 * built on top of the Oxs_RungeKuttaEvolve
 * class and includes a spin injection field torque.
 *
 */

#ifndef _OXS_SPINTSREVOLVE
#define _OXS_SPINTSREVOLVE
...
/* End includes */
class Oxs_SpinTSREvolve:public Oxs_TimeEvolver {
private:
  ...
  /// [1,-2,0,2,-1]/12h.  Otherwise, use 2 pt rule: [-1,0,1]/2h.
  ...
  // Spatially variable layer thickness
  Oxs_OwnedPointer<Oxs_ScalarField> thickness_init;
  mutable Oxs_MeshValue<OC_REAL8m> thickness;
  ...
  Oxs_ScalarOutput<Oxs_SpinTSREvolve> max_dm_dt_output;
  Oxs_ScalarOutput<Oxs_SpinTSREvolve> dE_dt_output;
  Oxs_ScalarOutput<Oxs_SpinTSREvolve> delta_E_output;
  Oxs_ScalarOutput<Oxs_SpinTSREvolve> ave_J_output;
  Oxs_VectorFieldOutput<Oxs_SpinTSREvolve> dm_dt_output;
  Oxs_VectorFieldOutput<Oxs_SpinTSREvolve> mxH_output;
  Oxs_VectorFieldOutput<Oxs_SpinTSREvolve> spin_torque_output;
  Oxs_VectorFieldOutput<Oxs_SpinTSREvolve> Jmp_output;
...
#define RKStepFuncSig(NAME) \
  ...
  RKStepFuncSig((Oxs_SpinTSREvolve::* rkstep_ptr));
  ...
  Oxs_SpinTSREvolve(const Oxs_SpinTSREvolve&);
  Oxs_SpinTSREvolve& operator=(const Oxs_SpinTSREvolve&);

public:
  virtual const char* ClassName() const; // ClassName() is
  /// automatically generated by the OXS_EXT_REGISTER macro.
  virtual OC_BOOL Init();
  Oxs_SpinTSREvolve(const char* name,     // Child instance id
		       Oxs_Director* newdtr, // App director
		       const char* argstr);  // MIF input block parameters
  virtual ~Oxs_SpinTSREvolve();
