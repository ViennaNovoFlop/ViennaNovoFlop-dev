...
# extension, whereas extobjs holds just bare base names.
set extsrcs [glob -nocomplain -- [file join ext *.cc]]
set extobjs {}
foreach src $extsrcs {
    lappend extobjs [file rootname [file tail $src]]
}

set lclsrcs [glob -nocomplain -- [file join local *.cc]]
set lclobjs {}
foreach src $lclsrcs {
    lappend lclobjs [file rootname [file tail $src]]
}

set psrcs [glob -nocomplain -- [file join preisach *.cc]]
set pobjs {}
foreach src $psrcs {
