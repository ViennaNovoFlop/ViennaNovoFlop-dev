...
// below) will use the ComputeEnergyChunk interface in a collated fashion
// to help minimize memory bandwidth usage.  On threaded OOMMF builds,
// these calls will be run in parallel and load balanced.
class Oxs_Energy; // Forward declaration
