...
_Oxs_DemagJobControl _Oxs_DemagFFTxThread::job_control;
...
_Oxs_DemagJobControl _Oxs_DemagiFFTxDotThread::job_control;
 ...
 ) const
{
...
#endif // REPORT_TIME
  {
    ...
    _Oxs_DemagFFTxThread::job_control.Init(rdimy*rdimz,MaxThreadCount,8);
  ...
  _Oxs_DemagiFFTxDotThread::job_control.Init(rdimy*rdimz,MaxThreadCount,8);
