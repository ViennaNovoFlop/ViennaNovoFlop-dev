...
//for(vit=bdry1_cells.begin();vit!=bdry1_cells.end();vit++) {
//mesh->Center(*vit,vtest);
//m.append(to_string(vtest.x)+to_string(vtest.y)+to_string(vtest.z)+"\n");
//}
//m.append("Boundary 2 list: \n");
//for(vit=bdry2_cells.begin();vit!=bdry2_cells.end();vit++) {
//mesh->Center(*vit,vtest);
//m.append(to_string(vtest.x)+to_string(vtest.y)+to_string(vtest.z)+"\n");
//}
