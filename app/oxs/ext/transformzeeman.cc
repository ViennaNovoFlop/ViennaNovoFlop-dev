    ...
    transform_type(identity), mesh_id(0)
{
  ...
  if(transform_type != identity) {
    command_options.push_back(Oxs_TclCommandLineOption("stage",1));
    command_options.push_back(Oxs_TclCommandLineOption("stage_time",1));
    command_options.push_back(Oxs_TclCommandLineOption("total_time",1));
