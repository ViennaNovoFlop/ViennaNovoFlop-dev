...
regexp \\\044Date:(.*)\\\044 {$Date: 2010-08-25 20:52:56 $} _ date
...
proc LaunchDialog { menuname itemlabel action } {
   ...
   if {[string match OPEN $action]} {
      ...
      Ow_FileDlg New dialogbox -callback DialogCallback \
         ...
         -dialog_title "Write Config -- [Oc_Main GetInstanceName]" \
...
proc GetDefaultSliceSpan {} {
    ...
    if {![IsRegularMesh]} {
        ...
        if {20*$zstep<$slicerange} {set zstep [expr {$slicerange/20.}]}
    }
