...
regexp \\\044Date:(.*)\\\044 {$Date: 2010-03-12 01:10:08 $} _ date
...
proc LaunchDialog { menuname itemlabel action } {
	...
	Ow_FileDlg New dialogbox -callback DialogCallback \
		-dialog_title "Save File -- [Oc_Main GetInstanceName]" \
	...
	Ow_FileDlg New dialogbox -callback DialogCallback \
		-dialog_title "Open File -- [Oc_Main GetInstanceName]" \
	...
	Ow_PrintDlg New dialogbox \
		...
		-dialog_title "Print -- [Oc_Main GetInstanceName]" \
                -menu_data [list $menuname $itemlabel] \
		-smart_menu $SmartDialogs \
                -crop_option 0 \
...
#
# AFAICT, Tk neither defines the keyboard to meta key assignments,
# nor provides any programatic way to discover the mapping.  So
...
proc ClearDataColumn { label } {
    ...
    #  but empty lists.
    global data_index data_value graph
